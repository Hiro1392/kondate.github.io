...
const defaultIngredients = [
  ...
  { name: "豚ロース肉", category: "肉", aliases: ["豚ロース", "とんカツ用"] },
  { name: "豚ひき肉", category: "肉", aliases: ["豚挽き肉", "豚ミンチ"] },
  { name: "牛切り落とし肉", category: "肉", aliases: ["牛切り落とし", "牛こま"] },
  { name: "鶏もも肉", category: "肉", aliases: ["鶏もも"] },
  { name: "鶏胸肉", category: "肉", aliases: ["鶏むね肉", "鶏むね"] },
  { name: "鶏ささ身", category: "肉", aliases: ["ささ身", "ささみ"] },
  ...
  { name: "まいたけ", category: "野菜", aliases: ["舞茸"] },
  { name: "マッシュルーム", category: "野菜", aliases: [] },
  { name: "玉ねぎ", category: "野菜", aliases: ["玉葱"] },
  { name: "ねぎ", category: "野菜", aliases: ["長ねぎ", "長ネギ"] },
  { name: "にら", category: "野菜", aliases: ["ニラ"] },
  ...
  { name: "大根", category: "野菜", aliases: [] },
  { name: "長いも", category: "野菜", aliases: ["長芋"] },
  ...
  { name: "ごはん", category: "その他", aliases: ["ご飯", "米"] },
  { name: "梅干し", category: "その他", aliases: ["梅干"] },
  { name: "春巻きの皮", category: "その他", aliases: [] },
  { name: "ホワイトソース缶", category: "その他", aliases: ["ホワイトソース"] },
  { name: "牛乳", category: "その他", aliases: [] },
  { name: "塩こぶ", category: "その他", aliases: ["塩昆布"] },
